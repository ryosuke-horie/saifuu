...
import { transformApiCategoriesToFrontend, transformApiCategoryToFrontend } from '../categories/transformers'
import {
...
describe('Subscriptions Transformers', () => {
  ...
  describe('transformApiSubscriptionToFrontend', () => {
    it('should transform API subscription to frontend format with category lookup', () => {
      ...
      const result = transformApiSubscriptionToFrontend(apiSubscription, mockCategories)
    ...
    it('should throw error for missing category', () => {
      ...
      expect(() => transformApiSubscriptionToFrontend(apiSubscription, mockCategories))
