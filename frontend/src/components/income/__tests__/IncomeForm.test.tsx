...
describe("IncomeForm", () => {
	...
	it("有効なデータで送信した場合、onSubmitが呼ばれること", async () => {
		...
		await user.selectOptions(screen.getByLabelText(/カテゴリ/), "101"); // 給与カテゴリのnumericId
	...
	it("編集モードで初期データが正しく表示されること", () => {
		const initialData: IncomeFormData = {
			...
			date: "2025-01-15",
			description: "ボーナス支給",
			categoryId: "102", // ボーナスカテゴリのnumericId
		};
