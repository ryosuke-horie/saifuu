...
import { ARIA_LABELS, DEFAULT_CATEGORY_COLOR, FILTER_STYLES } from "../../../constants/incomeFilters";
...
export const CategoryFilter = React.memo<CategoryFilterProps>(({
	...
	return (
		<div>
			<div className={FILTER_STYLES.LABEL}>
			...
			<div className={FILTER_STYLES.CATEGORY_GRID}>
				{categories.map((category) => {
					...
					return (
						<label
							key={category.id}
							className={FILTER_STYLES.CATEGORY_ITEM}
						>
							<input
								type="checkbox"
								checked={isChecked}
