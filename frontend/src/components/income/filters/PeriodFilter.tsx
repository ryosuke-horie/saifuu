		...
		return (
			<div className={containerClass}>
				...
				<div className="flex-1">
					<label htmlFor="period" className={FILTER_STYLES.LABEL}>
						{ARIA_LABELS.PERIOD}
					</label>
					<select
						id="period"
				...
				{period === "custom" && (
					<>
						<div className="flex-1">
							<label htmlFor="startDate" className={FILTER_STYLES.LABEL}>
						...
						<div className="flex-1">
							<label htmlFor="endDate" className={FILTER_STYLES.LABEL}>
