...
INSERT INTO `__new_categories`("id", "name", "type", "color", "created_at", "updated_at") SELECT "id", "name", "type", "color", "created_at", "updated_at" FROM `categories`;--> statement-breakpoint
